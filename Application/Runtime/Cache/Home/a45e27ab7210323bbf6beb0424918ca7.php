      ...
      <?php if($ItemPermn): ?><li>
          ...
          <!-- dropdown menu links -->
            <li><a href="#" id="share">分享</a></li>
             ...
             <?php if($ItemCreator): ?><li><a href="<?php echo U('Home/Item/add',array('item_id'=>$item['item_id']));?>">修改信息</a></li>          
              ...
              <li><a href="<?php echo U('Home/Item/delete',array('item_id'=>$item['item_id']));?>">删除</a></li><?php endif; ?>
...
<script src="/Public/js/item/show.js?v=1.12thirdtt"></script>