    ...
    <header class="row">
        <div class="head-left  pull-left">
            <ul class="inline">
                ...
                <li>
                    <input type="text" name="s_number" id="s_number" value="<?php echo ($page["s_number"]); ?>" placeholder="可选：顺序数字"  tabindex="3" >
                </li>
                <li>
                    <!-- 首次添加没有历史版本，不显示 -->
                    <?php if($page["page_id"] > 0): ?><a href="?s=home/page/history&page_id=<?php echo ($page["page_id"]); ?>">历史版本</a>
                        <?php else: endif; ?>
                </li>
            </ul>
        </div>
        <div class="head-right pull-right">
            ...
            <a href="?s=home/item/show&item_id=<?php echo ($item_id); ?>&page_id=<?php echo ($page["page_id"]); ?>" class="btn cancel">取消</a>
        </div>
    </header>
    <br>
    <!-- 插入模板的按钮组 -->
...
<script src="/Public/js/page/edit.js?v=1.1.2thirdon"></script>