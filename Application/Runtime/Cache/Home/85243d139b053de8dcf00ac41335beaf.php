 ...
 <div id="edit-cat" class="modal hide fade">
  ...
  <table class="table table-hover">
    ...
    <?php if($PageHistory): if(is_array($PageHistory)): foreach($PageHistory as $key=>$value): ?><TR>
        ...
        <td><a href="?s=home/page/edit&page_id=<?php echo ($page_id); ?>&page_history_id=<?php echo ($value["page_history_id"]); ?>">恢复到此版本</a></td>
      </TR><?php endforeach; endif; endif; ?>
  </table>

    <div class="modal-footer">
      <a href="?s=home/page/edit&page_id=<?php echo ($page_id); ?>" class="btn exist-cat">关闭</a>
      <a href="?s=home/page/edit&page_id=<?php echo ($page_id); ?>" class="btn btn-primary exist-cat">完成</a>
    </div>
 </div>
